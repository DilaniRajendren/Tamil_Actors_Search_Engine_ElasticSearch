...
are added to improve the quality of the search.  preprocess-finalize.py is used to produce these JSON data.
...
```
### கனாக்கண்டேன் திரைப்படத்தில் நடித்த 50 திரைப்படங்களுக்கு மேல் நடித்த 40 வயதிற்கு மேற்பட்ட இயக்குனராகவும் உள்ள சென்னையில் பிறக்காத நடிகர்கள்
```
GET /actors_db/_search
{
 "query": {
